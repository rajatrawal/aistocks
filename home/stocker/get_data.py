...
def total(stock, years=1, interest=False, wiki_views=False, indicators=False, period=14,yesterday=False):
    # main function to combine data from Yahoo Finance, Google Trends, Wikipedia and calculated indicators.
    df, start, end = main(stock, years=years,yesterday=yesterday)  # get data from Yahoo Finance and define star and end
    company = None
